...
const ProfilePage = () => {
  ...
  const save = async (event) => { event.preventDefault(); if (saving) return; setSaving(true); try { await saveProfile(form); setMessage('Profile saved.'); } finally { setSaving(false); } };
