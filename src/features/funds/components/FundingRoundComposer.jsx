  ...
  return (
    <ModalPortal>
      <div className="bal-dialog-overlay" role="presentation" onClick={onClose}>
        <form className="bal-dialog fund-round-composer" role="dialog" aria-modal="true" aria-labelledby="fund-round-composer-title" onClick={(event) => event.stopPropagation()} onSubmit={submit}>
          <div className="bal-dialog__head">
            <h2 id="fund-round-composer-title" className="bal-dialog__title text-headline">{t('fund.newRound')}</h2>
