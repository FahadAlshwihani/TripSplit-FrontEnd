...
const publicRoutes = [
  ...
  <Route path="/create-trip" element={<GatedRoute next="/create-trip"><CreateTrip /></GatedRoute>} key="create-trip" />,
  <Route path="/join-trip" element={<GatedRoute next="/join-trip"><JoinTrip /></GatedRoute>} key="join-trip" />,
